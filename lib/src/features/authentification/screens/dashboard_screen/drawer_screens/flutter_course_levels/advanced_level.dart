...
class FlutterAdvancedLevel extends StatefulWidget {
  const FlutterAdvancedLevel({Key? key}) : super(key: key);

  @override
  State<FlutterAdvancedLevel> createState() => _FlutterAdvancedLevelState();
}

class _FlutterAdvancedLevelState extends State<FlutterAdvancedLevel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: DSecondaryColor,
        title: Text("Advanced Level Tutorials", style: Theme.of(context).textTheme.headline4,),
        centerTitle: true,

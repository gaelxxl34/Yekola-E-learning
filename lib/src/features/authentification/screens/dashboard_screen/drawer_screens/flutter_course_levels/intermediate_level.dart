...
class FlutterIntermediateLevel extends StatefulWidget {
  const FlutterIntermediateLevel({Key? key}) : super(key: key);

  @override
  State<FlutterIntermediateLevel> createState() => _FlutterIntermediateLevelState();
}

class _FlutterIntermediateLevelState extends State<FlutterIntermediateLevel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: DSecondaryColor,
        title: Text("Intermediate Level Tutorials", style: Theme.of(context).textTheme.headline4,),
        centerTitle: true,

...
class FlutterBeginnerLevel extends StatefulWidget {
  const FlutterBeginnerLevel({Key? key}) : super(key: key);

  @override
  State<FlutterBeginnerLevel> createState() => _FlutterBeginnerLevelState();
}

class _FlutterBeginnerLevelState extends State<FlutterBeginnerLevel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: DSecondaryColor,
        title: Text("Beginner Level Tutorials", style: Theme.of(context).textTheme.headline4,),
        centerTitle: true,

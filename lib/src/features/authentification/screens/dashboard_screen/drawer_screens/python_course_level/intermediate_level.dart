...
class PythonIntermediateLevel extends StatefulWidget {
  const PythonIntermediateLevel({Key? key}) : super(key: key);

  @override
  State<PythonIntermediateLevel> createState() => _PythonIntermediateLevelState();
}

class _PythonIntermediateLevelState extends State<PythonIntermediateLevel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: DSecondaryColor,
        title: Text("Level 2 Tutorials", style: Theme.of(context).textTheme.headline4,),
        centerTitle: true,

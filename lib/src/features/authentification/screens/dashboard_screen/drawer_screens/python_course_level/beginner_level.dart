...
class PythonBeginnerLevel extends StatefulWidget {
  const PythonBeginnerLevel({Key? key}) : super(key: key);

  @override
  State<PythonBeginnerLevel> createState() => _PythonBeginnerLevelState();
}

class _PythonBeginnerLevelState extends State<PythonBeginnerLevel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: DSecondaryColor,
        title: Text("Level 1 Tutorials", style: Theme.of(context).textTheme.headline4,),
        centerTitle: true,
